...
### Final model
<img align="right" title="An example of final model, customer 105" width="350" src="../Capstone_project_2/DprtClustedGMM_result.png">Finally the implicit model was run for every group of costumer clustered by GMM model. The results are more aceptable comapre to the lat one. The average AUC of all clusters is . An axample of the result for customer 105 is given here. The top table shows the recommended items and lower table shows products that customer 105 had ordered. 
